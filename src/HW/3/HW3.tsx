...
export const HW3 = () => {
  ...
  return (
    <div id={'hw03'}>
      ...
      <input id={'hw03-input'} type="text" value={currentText} onChange={(e) => handleChange(e.target.value)} key={'hw03-input'} />

      <button id={'hw03-button'} onClick={handleSave} key={'hw03-button'}>
        Сохранить
      </button>
